 ...
 *
 * <p>This exception serves as the root of the exception hierarchy for the board game
 * application. It provides a common superclass for all domain-specific exceptions that may occur
 * during the execution of the application, allowing for consistent error handling and
 * categorization of different types of failures.</p>
 *
