...
class BoardFileWriterGsonTest {
  ...
  void writeBoard_validBoardAndPath_writesCorrectJson() throws IOException, BoardWritingException {
    ...
    try (MockedConstruction<FileWriter> mockedConstruction =
        Mockito.mockConstruction(
            ...
            (mock, context) -> {
              ...
              doAnswer(
                  ...
                  .when(mock)
                  .write(any(char[].class));

              doAnswer(
                      invocation -> {
                        stringWriter.write(
                            (char[]) invocation.getArgument(0),
              ...
              doAnswer(
                  ...
                  .when(mock)
                  .append(any(CharSequence.class), anyInt(), anyInt());
      ...
      String expectedJson =
          "{\"name\":\"Test Board\",\"description\":\"A test description\",\"rows\":5,\"columns\":5,\"startTileId\":0,\"endTileId\":24,\"tiles\":["
  ...
  void writeBoard_ioExceptionDuringWrite_throwsBoardWritingException() throws IOException {
    try (MockedConstruction<FileWriter> mockedConstruction =
      ...
      BoardWritingException ex =
          assertThrows(
              BoardWritingException.class, () -> boardWriter.writeBoard(mockPath, testBoard));
