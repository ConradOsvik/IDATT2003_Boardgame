...
/**
 * Event fired when a player bounces back from the end tile in Snakes and
 * Ladders.
 * 
 * <p>
 * Extends PlayerMovedEvent to track the movement from the end tile
 * back to the bounced position.
 * </p>
 */
