...
/**
 * Builder class for creating and configuring JavaFX {@link Label} instances.
 * Provides a fluent interface for setting various label properties.
 * <p>
 * Example usage:
 * 
 * <pre>{@code
...
public class LabelBuilder {
   ...
   * <p>
   * The label is initialized with default JavaFX properties and can be
   ...
   * <p>
   * This text will be shown as the label's content.
   * </p>
   *
   ...
   * <p>
   * This affects how the text is aligned horizontally within the label's bounds.
   * </p>
   *
   ...
   * <p>
   * When enabled, text that is too long will wrap to the next line instead of
   * being clipped.
   * </p>
   *
   ...
   * <p>
   * After this call, the label is ready to be added to a scene graph.
   * </p>
   *
