...
class PlayerMovedEventTest {
    ...
    void constructor_withValidArguments_shouldCreateEventWithPlayerMovedType() {
        PlayerMovedEvent event = new PlayerMovedEvent(mockPlayer, mockFromTile, mockToTile, steps, mockBoard);
        assertNotNull(event);
    ...
    void constructor_withSpecificTypeAndValidArguments_shouldCreateEventWithGivenType() {
        ...
        PlayerMovedEvent event = new PlayerMovedEvent(specificType, mockPlayer, mockFromTile, mockToTile, steps,
                mockBoard);
        assertNotNull(event);
