...
//
//  @Mock
//  private BoardGameFactory mockFactory;
//
//  @Mock
...
//
//    when(mockFactory.loadGameFromFile(any(), any())).thenReturn(mockGame);
...
//      facade.createGame("TestBoard");
//
//      verify(mockFactory).loadGameFromFile(BoardGameType.LADDER, "TestBoard");
...
//      assertThrows(BoardGameException.class, () -> {
//        facade.startGame();
//      });
//    }
//
