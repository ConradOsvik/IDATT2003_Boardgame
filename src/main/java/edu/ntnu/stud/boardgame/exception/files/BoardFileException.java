 ...
 *
 * <p>This exception is specifically used to indicate problems related to board files, such as
 * invalid format, missing required data, or inability to read/write board configuration files.
 *
 * @see FileException
 */
