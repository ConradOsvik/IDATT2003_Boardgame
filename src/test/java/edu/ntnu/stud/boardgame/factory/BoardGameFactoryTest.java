...
class BoardGameFactoryTest {
    ...
    void createGame_ladderGame_predefined_returnsLadderGame() throws BoardFileException {
        ...
        try (MockedStatic<LadderGameBoardFactory> mockedFactory = Mockito.mockStatic(LadderGameBoardFactory.class)) {
    ...
    void createGame_monopolyGame_fromFile_returnsMonopolyGame() throws BoardFileException {
        Board mockBoard = mock(Board.class);
        when(mockBoardFileService.loadBoard(BoardGameType.MONOPOLY, "MyMonopolyBoard")).thenReturn(mockBoard);
    ...
    void createGame_nullType_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> boardGameFactory.createGame(null, "boardName"));
    }

    @Test
    void createGame_nullBoardName_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> boardGameFactory.createGame(BoardGameType.LADDER, null));
    }

    @Test
    void createGame_emptyBoardName_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> boardGameFactory.createGame(BoardGameType.LADDER, "  "));
    }
    ...
    void createGame_fileServiceThrowsException_propagatesException() throws BoardFileException {
        ...
        assertThrows(BoardFileException.class, () -> boardGameFactory.createGame(BoardGameType.LADDER, "FaultyBoard"));
    }
    ...
    void getAvailableGameBoards_monopoly_combinesPredefinedAndFileBoards() {
        ...
        try (MockedStatic<MonopolyBoardFactory> mockedFactory = Mockito.mockStatic(MonopolyBoardFactory.class)) {
    ...
    void getAvailableGameBoards_nullGameType_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> boardGameFactory.getAvailableGameBoards(null));
    }
}